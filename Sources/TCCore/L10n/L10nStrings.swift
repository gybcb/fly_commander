...
public enum L10nTable {
    public static let en: [L10nKey: String] = [
        ...
        .remoteConnectMenu: "Connect to Remote…", .toolbarRemoteConnect: "Connect to Remote",
        ...
        .toolbarConnect: "Connect", .toolbarSMB: "SMB", .toolbarTheme: "Theme",
        .protoSFTP: "SFTP", .protoSMB: "SMB", .protoFTP: "FTP",
        .fieldTLS: "TLS encryption (FTPS, port 990)",
        .protoNotWired: "{0} is not wired yet",
        .themeWindowTitle: "Theme", .sftpWindowTitle: "SFTP Connection",
        .smbWindowTitle: "SMB Connection", .ftpWindowTitle: "FTP Connection",
        .searchWindowTitle: "Find Files",
        ...
        .statusFolder: "Folder",
        .statusSelectedTotal: "{0} selected · total {1}",
        .statusEmptyPane: "Empty",
        ...
        .fieldConnName: "Name", .saveConnection: "Save", .deleteConnection: "Delete",
        .savedConnectionsTitle: "Saved connections",
        .savedListEmpty: "No saved connections yet. Fill the form and press Save.",
        .savedListFull: "Saved list is full (max 10). Delete one first.",
        .savedDuplicateTitle: "Replace existing?",
        .savedDuplicateBody: "A saved connection with the same name already exists. Replace it?",
        .savedDone: "Saved",
        // —— 命令栏回显（T6）——
        ...
        .ftpUsage: "Usage: ftp [host[:port]]",
        .ftpOpenedHost: "Connection window opened (host: {0})", .ftpOpened: "FTP connection window opened",
        ...
        .helpFtp: "  ftp [host[:port]]    Open the FTP connection window (host/port prefilled)",
    ...
    public static let zh: [L10nKey: String] = [
        ...
        .remoteConnectMenu: "连接到远端…", .toolbarRemoteConnect: "连接到远端",
        ...
        .toolbarConnect: "连接", .toolbarSMB: "SMB", .toolbarTheme: "主题",
        .protoSFTP: "SFTP", .protoSMB: "SMB", .protoFTP: "FTP",
        .fieldTLS: "TLS 加密（FTPS，端口 990）",
        .protoNotWired: "{0} 尚未接线",
        .themeWindowTitle: "主题", .sftpWindowTitle: "SFTP 连接",
        .smbWindowTitle: "SMB 连接", .ftpWindowTitle: "FTP 连接",
        .searchWindowTitle: "搜索文件",
        ...
        .statusFolder: "文件夹",
        .statusSelectedTotal: "已选 {0} 项 · 合计 {1}",
        .statusEmptyPane: "空目录",
        ...
        .fieldConnName: "名称", .saveConnection: "保存", .deleteConnection: "删除",
        .savedConnectionsTitle: "已保存的连接",
        .savedListEmpty: "还没有已保存的连接。填写表单后点「保存」。",
        .savedListFull: "已保存列表已满（最多 10 条），请先删除一条。",
        .savedDuplicateTitle: "覆盖同名条目？",
        .savedDuplicateBody: "已存在同名的保存连接，要覆盖它吗？",
        .savedDone: "已保存",
        // —— 命令栏回显（T6）——
        ...
        .ftpUsage: "用法：ftp [host[:port]]",
        .ftpOpenedHost: "已打开连接窗（主机：{0}）", .ftpOpened: "已打开 FTP 连接窗",
        ...
        .helpFtp: "  ftp [host[:port]]    打开 FTP 连接窗（可预填主机/端口）",
